...
## @type: DataSource
## @args: [database = "airbnb-listings", table_name = "fuckall_2019_december", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
...
applymapping1 = ApplyMapping.apply(frame = datasource1, mappings = [("id", "long", "id", "long"), ("last_scraped", "string", "last_scraped", "timestamp"), ("host_id", "long", "host_id", "long"), ("host_name", "string", "host_name", "string"), ("host_since", "string", "host_since", "string"), ("host_response_time", "string", "host_response_time", "string"), ("host_response_rate", "string", "host_response_rate", "float"), ("host_neighbourhood", "string", "host_neighbourhood", "string"), ("host_total_listings_count", "double", "host_total_listings_count", "double"), ("host_identity_verified", "string", "host_identity_verified", "string"), ("neighbourhood_group_cleansed", "string", "neighbourhood_group_cleansed", "string"), ("city", "string", "city", "string"), ("state", "string", "state", "string"), ("zipcode", "long", "zipcode", "long"), ("country_code", "string", "country_code", "string"), ("country", "string", "country", "string"), ("latitude", "double", "latitude", "double"), ("longitude", "double", "longitude", "double"), ("property_type", "string", "property_type", "string"), ("room_type", "string", "room_type", "string"), ("accommodates", "long", "accommodates", "long"), ("bathrooms", "double", "bathrooms", "double"), ("bedrooms", "double", "bedrooms", "double"), ("beds", "double", "beds", "double"), ("bed_type", "string", "bed_type", "string"), ("square_feet", "double", "square_feet", "double"), ("price", "string", "price", "float"), ("weekly_price", "string", "weekly_price", "float"), ("monthly_price", "string", "monthly_price", "float"), ("security_deposit", "string", "security_deposit", "float"), ("cleaning_fee", "string", "cleaning_fee", "float"), ("guests_included", "long", "guests_included", "long"), ("extra_people", "string", "extra_people", "float"), ("number_of_reviews", "long", "number_of_reviews", "long"), ("first_review", "string", "first_review", "timestamp"), ("last_review", "string", "last_review", "timestamp"), ("review_scores_value", "double", "review_scores_value", "double"), ("cancellation_policy", "string", "cancellation_policy", "string")], transformation_ctx = "applymapping1")
## @type: ResolveChoice
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://craigslist-final-project/Neighbourhood/test"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": "s3://craigslist-final-project/Neighbourhood/test", "partitionKeys":["last_scraped"]}, format = "parquet", transformation_ctx = "datasink4")
job.commit()